...
--
-- Table structure for table `gpcs_codes`
--

CREATE TABLE `gpcs_codes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `country_code` varchar(255) NOT NULL,
  `first_part` varchar(255) NOT NULL,
  `second_part` varchar(255) NOT NULL,
  `gpcscode` varchar(255) NOT NULL,
...
(4, '2025_03_04_200636_create_gpcs_codes_table', 1),
(5, '2025_03_04_201316_create_tld_country_codes_table', 1),
(6, '2025_03_05_082638_create_roles_table', 1),
(7, '2025_03_05_085246_create_user_roles_table', 1),
(8, '2025_03_05_111358_add_column_to_users', 1),
(9, '2025_03_06_075731_create_personal_access_tokens_table', 1);
...
--
-- Table structure for table `tld_country_codes`
--

CREATE TABLE `tld_country_codes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `domain_country_code` varchar(255) NOT NULL,
  `map_code` varchar(255) NOT NULL,
...
--
-- Indexes for table `gpcs_codes`
--
ALTER TABLE `gpcs_codes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `gpcs_codes_user_id_foreign` (`user_id`);
...
--
-- Indexes for table `tld_country_codes`
--
ALTER TABLE `tld_country_codes`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `gpcs_codes`
--
ALTER TABLE `gpcs_codes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tld_country_codes`
--
ALTER TABLE `tld_country_codes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `gpcs_codes`
--
ALTER TABLE `gpcs_codes`
  ADD CONSTRAINT `gpcs_codes_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
